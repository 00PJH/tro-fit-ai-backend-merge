...
def main():
    # 경로 설정
    # 이 파일 위치: vision_ai/test/media_pipe_test/pose_test.py
    script_dir   = os.path.dirname(os.path.abspath(__file__))
    project_root = os.path.abspath(os.path.join(script_dir, "..", "..", ".."))  # trofit/

    model_path = os.path.join(project_root, "models", "pose_landmarker_full.task")
    img_dir    = os.path.join(project_root, "vision_ai", "test", "img_test")
